        ...
        <div class="col-span-1 md:col-span-8">
            <a href="/artikel">
                <div class="relative h-[20rem] md:h-[28rem] rounded-xl overflow-hidden">
                    <img src="{{ asset('images/berita1.jpg') }}" class="w-full h-full object-cover" alt="Main News">
                ...
                <div class="space-y-4">
                    ...
                    <div class="group">
                        <a href="/artikel" class="flex items-start gap-3">
                            ...
                            @endphp
                            <img src="{{ asset('images/berita' . $imageIndex . '.' . $extension) }}" alt="Artikel" class="w-16 md:w-20 h-16 md:h-20 object-cover rounded-lg">
                            <div>
