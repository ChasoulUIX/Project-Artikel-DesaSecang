...
@section('content')
<div class="container mt-4 dark:bg-gray-900">
        ...
        <div class="col-span-8">
            <a href="/artikel">
                <div class="relative h-[28rem] rounded-xl overflow-hidden">
                    <img src="{{ asset('images/ronald.jpg') }}" class="w-full h-full object-cover" alt="Main News">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-8">
            <div class="grid grid-cols-1 gap-6">
                @for ($i = 1; $i <= 9; $i++)
                <a href="/artikel" class="flex gap-4 items-start">
