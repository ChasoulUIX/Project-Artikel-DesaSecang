                ...
                <div class="divide-y dark:divide-gray-700">
                    @for ($i = 1; $i <= 5; $i++)
                        <a href="/artikel" class="flex items-center gap-4 p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            <span class="text-2xl font-bold text-blue-900 dark:text-blue-400">{{ $i }}</span>
                            <p class="font-medium text-gray-800 dark:text-gray-200">Di Era Kultura Konsumerisme Harus Pandai Mengambil Manfaat dari Perubahan</p>
                        </a>
                    @endfor
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <a href="/artikel" class="flex flex-col sm:flex-row gap-4 items-start">
                    <div class="w-full sm:w-48 h-48 sm:h-32 flex-shrink-0">
                        @php
                            $imageNumber = rand(1, 9);
                            $extension = match($imageNumber) {
                                1, 2, 4 => 'jpg',
                                3, 5, 6 => 'jpeg',
                                7, 8, 9 => 'webp',
                                default => 'jpg'
                    ...
                    <div class="flex-1">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 hover:text-blue-600 dark:hover:text-blue-400">
                ...
                <div class="space-y-4">
                    ...
                    <div class="group">
                        <a href="/artikel" class="flex items-start gap-3">
                            ...
                            @endphp
                            <img src="{{ asset('images/berita' . $imageNumber . '.' . $extension) }}" alt="Artikel" class="w-16 sm:w-20 h-16 sm:h-20 object-cover rounded-lg">
                            <div>
