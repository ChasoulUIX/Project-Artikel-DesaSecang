...
<div class="container px-2.5 sm:px-4 mt-4 dark:bg-gray-900">
    ...
    <h2 class="mb-4 dark:text-white">{{ $categoryName ?? 'Politik' }}</h2>
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm text-center">
        ...
        <p class="text-gray-600 dark:text-gray-300">Saat ini belum ada artikel tersedia dalam kategori Politik.</p>
    </div>
    @endif
</div>
@endsection
