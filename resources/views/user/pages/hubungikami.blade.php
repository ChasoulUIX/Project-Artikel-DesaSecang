...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        ...
        <section>
            <div class="flex items-center gap-2 mb-8">
                ...
                <h2 class="text-3xl font-bold text-blue-900 dark:text-blue-500">Form Kontak</h2>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="email" class="block text-gray-700 dark:text-gray-200 font-medium mb-2">Email</label>
                        <input type="email" name="email" id="email" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="pesan" class="block text-gray-700 dark:text-gray-200 font-medium mb-2">Pesan</label>
                        <textarea name="pesan" id="pesan" rows="5" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></textarea>
                    </div>
                    <button type="submit" class="w-full bg-blue-900 dark:bg-blue-600 text-white font-medium py-3 rounded-lg hover:bg-blue-800 dark:hover:bg-blue-500 transition-colors">
                        Kirim Pesan
                    </button>
                </form>
            </div>
        ...
        <section>
            <div class="flex items-center gap-2 mb-8">
                <div class="w-10 h-1 bg-blue-900 dark:bg-blue-500 rounded-full"></div>
                <h2 class="text-3xl font-bold text-blue-900 dark:text-blue-500">Informasi Kontak</h2>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 space-y-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300">info@desasecang.com</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300">(0321) 123456</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300">Jl. Raya Secang No. 123<br>Desa Secang, Kec. Secang<br>Magelang, Jawa Tengah</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <section class="mb-16">
        <div class="flex items-center gap-2 mb-8">
            <div class="w-10 h-1 bg-blue-900 dark:bg-blue-500 rounded-full"></div>
            <h2 class="text-3xl font-bold text-blue-900 dark:text-blue-500">Lokasi Kami</h2>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
