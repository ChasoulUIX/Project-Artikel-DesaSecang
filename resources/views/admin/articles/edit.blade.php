        ...
        <div class="card-body">
            ...
            <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @if ($article->image)
                        <div class="mb-3">
                            <img src="{{ url('images/' . $article->image) }}" width="200" alt="Gambar Artikel Saat Ini">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control summernote" id="description" name="description" rows="10">{{ old('description', $article->description) }}</textarea>
                </div>
